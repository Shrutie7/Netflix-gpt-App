...
const useOnAirTvshow = () =>{ 
    ...
    //  convert/fulfill promise with await and change to readable stream with data.json()
      ...
      dispatch(addOnAirTvShow(jsondata.results))
    };
